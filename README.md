...
This web application was tested manually by self, as well as web developer friends and a few code-institute peers. It was tested on different screen sizes and browsers.

#### USER STORY 1. As the business owner I can log in so that I can access the site's backend.
